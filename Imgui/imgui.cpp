...
{
	return MyButtonEx(label, size_arg, inuse, 0);
}

bool ImGui::MyButtonEx(const char* label, const ImVec2& size_arg, bool inuse, ImGuiButtonFlags flags)
{
...
void ImGui::RenderOutlinedText(ImVec2 pos, const char* text, const char* text_end, bool hide_text_after_hash)
{
	ImGuiContext& g = *GImGui;
	ImGuiWindow* window = g.CurrentWindow;
	...
	if (text_len > 0)
	{
		...
		window->DrawList->AddText(g.Font, g.FontSize, ImVec2(pos.x + 1, pos.y), GetColorU32(ImVec4(0.00f, 0.00f, 0.00f, 1.00f)), text, text_display_end);
		window->DrawList->AddText(g.Font, g.FontSize, ImVec2(pos.x, pos.y + 1), GetColorU32(ImVec4(0.00f, 0.00f, 0.00f, 1.00f)), text, text_display_end);
		window->DrawList->AddText(g.Font, g.FontSize, pos, GetColorU32(ImGuiCol_Text), text, text_display_end);
		window->DrawList->AddText(g.Font, g.FontSize, ImVec2(pos.x - 1, pos.y), GetColorU32(ImVec4(0.00f, 0.00f, 0.00f, 1.00f)), text, text_display_end);
		window->DrawList->AddText(g.Font, g.FontSize, ImVec2(pos.x, pos.y - 1), GetColorU32(ImVec4(0.00f, 0.00f, 0.00f, 1.00f)), text, text_display_end);
...
void ImGui::RenderTextClippedOutlined(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align, const ImRect* clip_rect)
{
	// Hide anything after a '##' string
	const char* text_display_end = FindRenderedTextEnd(text, text_end);
	const int text_len = (int)(text_display_end - text);
	...
	{
		ImVec4 fine_clip_rect(clip_min->x, clip_min->y, clip_max->x, clip_max->y);
		window->DrawList->AddText(g.Font, g.FontSize, ImVec2(pos.x + 1, pos.y), GetColorU32(ImVec4(0.00f, 0.00f, 0.00f, 1.00f)), text, text_display_end, 0.0f, &fine_clip_rect);
		window->DrawList->AddText(g.Font, g.FontSize, ImVec2(pos.x, pos.y + 1), GetColorU32(ImVec4(0.00f, 0.00f, 0.00f, 1.00f)), text, text_display_end, 0.0f, &fine_clip_rect);
		window->DrawList->AddText(g.Font, g.FontSize, ImVec2(pos.x - 1, pos.y), GetColorU32(ImVec4(0.00f, 0.00f, 0.00f, 1.00f)), text, text_display_end, 0.0f, &fine_clip_rect);
		window->DrawList->AddText(g.Font, g.FontSize, ImVec2(pos.x, pos.y - 1), GetColorU32(ImVec4(0.00f, 0.00f, 0.00f, 1.00f)), text, text_display_end, 0.0f, &fine_clip_rect);
	...
	{
		window->DrawList->AddText(g.Font, g.FontSize, ImVec2(pos.x + 1, pos.y), GetColorU32(ImVec4(0.00f, 0.00f, 0.00f, 1.00f)), text, text_display_end, 0.0f, NULL);
		window->DrawList->AddText(g.Font, g.FontSize, ImVec2(pos.x, pos.y + 1), GetColorU32(ImVec4(0.00f, 0.00f, 0.00f, 1.00f)), text, text_display_end, 0.0f, NULL);
		window->DrawList->AddText(g.Font, g.FontSize, ImVec2(pos.x - 1, pos.y), GetColorU32(ImVec4(0.00f, 0.00f, 0.00f, 1.00f)), text, text_display_end, 0.0f, NULL);
		window->DrawList->AddText(g.Font, g.FontSize, ImVec2(pos.x, pos.y - 1), GetColorU32(ImVec4(0.00f, 0.00f, 0.00f, 1.00f)), text, text_display_end, 0.0f, NULL);
...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags, bool tab, bool selected)
{
	...
	//if (selected)
	//	window->DrawList->AddRect(bb.Min, bb.Max, GetColorU32(ImVec4(1.f, 1.f, 1.f, 1.f)), 0.0f);
...
bool ImGui::SliderBehavior2(const ImRect& frame_bb, ImGuiID id, float* v, float v_min, float v_max, float power, int decimal_precision, ImGuiSliderFlags flags)
{
	ImGuiContext& g = *GImGui;
	ImGuiWindow* window = GetCurrentWindow();
	const ImGuiStyle& style = g.Style;
...
bool ImGui::Checkbox(const char* label, bool* v)
{
	...
	if (label_size.x > 0.0f)
		RenderText(text_bb.GetTL() - ImVec2(20, 4.1f), label);
